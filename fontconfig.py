...
fc.FcValueSave.argtypes = (ct.POINTER(FC.Value),)
...
fc.FcPatternAdd.argtypes = (ct.c_void_p, ct.c_char_p, ct.POINTER(FC.Value), FC.Bool)
fc.FcPatternAddWeak.restype = FC.Bool
fc.FcPatternAddWeak.argtypes = (ct.c_void_p, ct.c_char_p, ct.POINTER(FC.Value), FC.Bool)
